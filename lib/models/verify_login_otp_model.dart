...
class VerifyLoginOtpModel {
  ...
  factory VerifyLoginOtpModel.fromRawJson(String str) => VerifyLoginOtpModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory VerifyLoginOtpModel.fromJson(Map<String, dynamic> json) => VerifyLoginOtpModel(
